...
MATCL_REGISTER_3_FUNC(f_fma_f, matcl::fma_f, mp_float, mp_float, mp_float, mdyf::fma_f)
MATCL_REGISTER_3_FUNC(f_fms_f, matcl::fms_f, mp_float, mp_float, mp_float, mdyf::fms_f)
MATCL_REGISTER_3_FUNC(f_fma_a, matcl::fma_a, mp_float, mp_float, mp_float, mdyf::fma_a)
MATCL_REGISTER_3_FUNC(f_fms_a, matcl::fms_a, mp_float, mp_float, mp_float, mdyf::fms_a)
MATCL_REGISTER_4_FUNC(f_dot2_a, matcl::dot2_a, mp_float, mp_float, mp_float, mp_float, mdyf::dot2_a)
