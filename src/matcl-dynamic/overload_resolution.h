...
class overload_set
{
    ...
    private:
        ...
        overload_set(const overload_set&) = delete;
        overload_set& operator=(const overload_set&) = delete;

    public:
        overload_set(Integer over_num);
        ~overload_set();

        overload_set(overload_set&& other);
...
class candidate_set
{
    ...
    public:
        ...
        void				push_back(function fun_evl, Type ret, 
