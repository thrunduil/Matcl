...
MATCL_REGISTER_3_FUNC(fma_f, matcl::fma_f, Real, Real, Real, mdyf::fma_f)
MATCL_REGISTER_3_FUNC(fms_f, matcl::fms_f, Real, Real, Real, mdyf::fms_f)
MATCL_REGISTER_3_FUNC(fma_a, matcl::fma_a, Real, Real, Real, mdyf::fma_a)
MATCL_REGISTER_3_FUNC(fms_a, matcl::fms_a, Real, Real, Real, mdyf::fms_a)
MATCL_REGISTER_4_FUNC(dot2_a, matcl::dot2_a, Real, Real, Real, Real, mdyf::dot2_a)
