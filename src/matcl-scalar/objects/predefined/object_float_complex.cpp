...
MATCL_REGISTER_SCALAR_FUNC(f_##fn, matcl::fn, Float_complex, mdyf::fn)
...
MATCL_REGISTER_BIN_FUNC(ldexp1, matcl::ldexp, Float_complex, Integer, mdyf::ldexp)
MATCL_REGISTER_BIN_FUNC(f_hypot_1, matcl::hypot, Float_complex, Float_complex, mdyf::hypot)
MATCL_REGISTER_BIN_FUNC(f_hypot_2, matcl::hypot, Float_complex, Float, mdyf::hypot)
MATCL_REGISTER_BIN_FUNC(f_hypot_3, matcl::hypot, Float, Float_complex, mdyf::hypot)

MATCL_REGISTER_BIN_FUNC(f_pow_1, matcl::pow, Float_complex, Float_complex, mdyf::pow)
MATCL_REGISTER_BIN_FUNC(f_pow_2, matcl::pow, Float_complex, Integer, mdyf::pow)
MATCL_REGISTER_BIN_FUNC(f_pow_3, matcl::pow, Float_complex, Float, mdyf::pow)
MATCL_REGISTER_BIN_FUNC(f_pow_4, matcl::pow, Integer, Float_complex, mdyf::pow)
MATCL_REGISTER_BIN_FUNC(f_pow_5, matcl::pow, Float, Float_complex, mdyf::pow)

MATCL_REGISTER_BIN_FUNC(f_pow_c_1, matcl::pow_c, Float_complex, Float_complex, mdyf::pow_c)
MATCL_REGISTER_BIN_FUNC(f_pow_c_2, matcl::pow_c, Float_complex, Integer, mdyf::pow_c)
MATCL_REGISTER_BIN_FUNC(f_pow_c_3, matcl::pow_c, Float_complex, Float, mdyf::pow_c)
MATCL_REGISTER_BIN_FUNC(f_pow_c_4, matcl::pow_c, Integer, Float_complex, mdyf::pow_c)
MATCL_REGISTER_BIN_FUNC(f_pow_c_5, matcl::pow_c, Float, Float_complex, mdyf::pow_c)

MATCL_REGISTER_BIN_FUNC(eeq1, eeq_nan, Float_complex, Float_complex, mdyf::eeq_nan)
MATCL_REGISTER_BIN_FUNC(eeq2, eeq_nan, Float, Float_complex, mdyf::eeq_nan)
MATCL_REGISTER_BIN_FUNC(eeq3, eeq_nan, Float_complex, Float, mdyf::eeq_nan)

MATCL_REGISTER_BIN_FUNC(neq1, neq_nan, Float_complex, Float_complex, mdyf::neq_nan)
MATCL_REGISTER_BIN_FUNC(neq2, neq_nan, Float, Float_complex, mdyf::neq_nan)
MATCL_REGISTER_BIN_FUNC(neq3, neq_nan, Float_complex, Float, mdyf::neq_nan)

MATCL_REGISTER_TEMPL_1_FUNC(f_bernoulli_b2n_fc,bernoulli_b2n,Float_complex,Integer,mdyf::bernoulli_b2n)
MATCL_REGISTER_TEMPL_0_FUNC(f_max_bernoulli_b2n_fc,max_bernoulli_b2n,Float_complex,mdyf::max_bernoulli_b2n)
MATCL_REGISTER_TEMPL_1_FUNC(f_factorial_fc,factorial,Float_complex,Integer,mdyf::factorial)
MATCL_REGISTER_TEMPL_1_FUNC(f_double_factorial_fc,double_factorial,Float_complex,Integer,mdyf::double_factorial)
MATCL_REGISTER_TEMPL_2_FUNC(f_binomial_coefficient_fc,binomial_coefficient,Float_complex,Integer,Integer,mdyf::binomial_coefficient)
