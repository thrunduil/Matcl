...
// by means of the Aitken's delta^2 algorithm. An estimate of the absolute
// error is also given.
// The delta^2 algorithm accelerates convergence of sequence of the form:
//      s_n ~ s + c_j l^n; |l| < 1, n -> inf
// Aitken delta algorithm is able to accelerate linearly convergent sequences
// and find the antilimit of a divergent sequence, but is not able to 
// accelerate a logarithmically convergent sequence.
//
...
class aitken_delta : protected details::seq_transform_base<Float>
{
    public:
...
#include "matcl-scalar/details/sequence/aitken_delta.inl"