...
struct make_complex_type<true,Value>
{ 
    using type = typename complex_type<Value>::type; 
};
...
template<class Value_1, class Value_2>
struct unify_types<mdy::object_type<Value_1>, Value_2>
{
    using real_1            = typename real_type<Value_1>::type;
    using real_2            = typename real_type<Value_2>::type;
    using ret_real          = typename unify_real_types<real_1, real_2>::type;
    ...
    using type              = mdy::object_type<type0>;
};

template<class Value_1, class Value_2>
struct unify_types<mdy::object_type<Value_1>, mdy::object_type<Value_2>>
{
    using real_1            = typename real_type<Value_1>::type;
    using real_2            = typename real_type<Value_2>::type;
    using ret_real          = typename unify_real_types<real_1, real_2>::type;
...
template<class Value_1, class Value_2>
struct unify_types<Value_1, mdy::object_type<Value_2>>
{
    using real_1            = typename real_type<Value_1>::type;
    using real_2            = typename real_type<Value_2>::type;
    using ret_real          = typename unify_real_types<real_1, real_2>::type;
