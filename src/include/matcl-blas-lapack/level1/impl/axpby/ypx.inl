...
struct ypx<TY, TX, Rows, false, details::true_t>
{
    force_inline
...
struct ypx<TY, TY, Rows, true, details::true_t>
{
    force_inline
    ...
    static void eval(TY* Y1, Integer Y_step, const TY* X1, Integer X_step, Integer rows)
    {
        ...
        return ypx<TY,TY,Rows,false,details::true_t>::eval(Y1, Y_step, X1, X_step, rows);
    };
};
