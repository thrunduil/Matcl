...
/// generic interfase of BLAS and LAPACK from CLAPACK

namespace f2c
{

typedef /*long*/ int integer; // long commented out to fix linux build
...
integer isamin_(integer *n, real *x, integer *incx);

integer idamax_(integer *n, doublereal *x, integer *incx);
integer idamin_(integer *n, doublereal *x, integer *incx);

integer icamax_(integer *n, complex *x, integer *incx); 
integer icamin_(integer *n, complex *x, integer *incx); 

integer izamax_(integer *n, doublecomplex *x, integer *incx); 
integer izamin_(integer *n, doublecomplex *x, integer *incx); 
