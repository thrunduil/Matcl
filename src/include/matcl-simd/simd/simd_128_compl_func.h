...
operator*(const simd_compl<Val,reg_128>& x, const simd_compl<Val,reg_128>& y);

// vector multiply x * y, where x is a real vector
template<class Val> simd_compl<Val,reg_128>
operator*(const simd<Val,reg_128>& x, const simd_compl<Val,reg_128>& y);

// vector multiply x * y, where y is a real vector
template<class Val> simd_compl<Val,reg_128>
operator*(const simd_compl<Val,reg_128>& x, const simd<Val,reg_128>& y);
...
template<class Val>
simd_compl<Val,reg_128> 
operator-(const simd_compl<Val,reg_128>& x);

// vector of elements in reverse order
template<class Val>
simd_compl<Val,reg_128> reverse(const simd_compl<Val,reg_128>& x);
...
template<class Val>
typename simd_compl<Val,reg_128>::value_type
sum_all(const simd_compl<Val,reg_128>& x);
