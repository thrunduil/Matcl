...
force_inline
simd<int32_t, 128, nosimd_tag>::simd(const impl_type& v)
{
    data[0] = v[0];
    data[1] = v[1];
    data[2] = v[2];
...
force_inline
simd<int32_t, 128, nosimd_tag> simd<int32_t, 128, nosimd_tag>::broadcast(const int32_t* arr)
{
...
template<int Pos>
force_inline
int32_t simd<int32_t, 128, nosimd_tag>::get() const
{ 
    return data[Pos]; 
};
...
template<int Pos>
force_inline
void simd<int32_t, 128, nosimd_tag>::set(int32_t val)
{ 
    data[Pos] = val; 
};
...
force_inline simd<int32_t, 128, nosimd_tag>
simd<int32_t, 128, nosimd_tag>::gather(const int32_t* arr, const simd_128_int32& ind)
{
    simd<int32_t, 128, nosimd_tag> ret;
...
force_inline simd<int32_t, 128, nosimd_tag> 
simd<int32_t, 128, nosimd_tag>::gather(const int32_t* arr, const simd_128_int64& ind)
{
    simd<int32_t, 128, nosimd_tag> ret;
...
simd<int32_t, 128, nosimd_tag>::convert_to_float() const
{
    ...
    ret.data[2] = float(data[2]);
    ret.data[3] = float(data[3]);
