...
template<>
class alignas(32) simd_compl<double, reg_256>
{
    public:
        // implementation type
        using impl_type     = simd<double, reg_256>;
        ...
        using simd_half     = simd_compl<double, reg_128>;
    ...
    public:
        ...
        simd_compl(simd_half lo, simd_half hi);
...
template<>
class alignas(32) simd_compl<float, reg_256>
{
    public:
        // implementation type
        using impl_type     = simd<float, reg_256>;
        ...
        // type of vector storing half of elements
        using simd_half     = simd_compl<float, reg_128>;
