...
template<Integer M, Integer N, Mat_array Array, class Deps, class Assign_Type,
                class... Items>
...
template<Integer M, Integer N, Mat_array Array, class Deps, Integer Pos, class Scalar>
