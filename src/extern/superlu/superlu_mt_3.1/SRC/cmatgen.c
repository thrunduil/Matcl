 ...
 */
void
cband(int_t n, int_t b, int_t nonz, complex **nzval, int_t **rowind, int_t **colptr)
{
 ...
 */
void
cblockdiag(int_t nb, /* number of blocks */
	   int_t bs, /* block size */
	   int_t nonz, complex **nzval, int_t **rowind, int_t **colptr)
{
    int iseed[] = {1992,1993,1994,1995};    
