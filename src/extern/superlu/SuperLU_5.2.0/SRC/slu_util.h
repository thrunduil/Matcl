...
#define CHECK_MALLOC(where) {                 \
    SUPERLU_EXPORT int superlu_malloc_total;        \
...
SUPERLU_EXPORT int     input_error(char *, int *);

SUPERLU_EXPORT void    Destroy_SuperMatrix_Store(SuperMatrix *);
SUPERLU_EXPORT void    Destroy_CompCol_Matrix(SuperMatrix *);
SUPERLU_EXPORT void    Destroy_CompRow_Matrix(SuperMatrix *);
SUPERLU_EXPORT void    Destroy_SuperNode_Matrix(SuperMatrix *);
SUPERLU_EXPORT void    Destroy_CompCol_Permuted(SuperMatrix *);
SUPERLU_EXPORT void    Destroy_Dense_Matrix(SuperMatrix *);
SUPERLU_EXPORT void    get_perm_c(int, SuperMatrix *, int *);
SUPERLU_EXPORT void    set_default_options(superlu_options_t *options);
SUPERLU_EXPORT void    ilu_set_default_options(superlu_options_t *options);
SUPERLU_EXPORT void    sp_preorder (superlu_options_t *, SuperMatrix*, int*, int*,
			    SuperMatrix*);
SUPERLU_EXPORT void    superlu_abort_and_exit(char*);
SUPERLU_EXPORT void    *superlu_malloc (size_t);
SUPERLU_EXPORT int     *intMalloc (int);
SUPERLU_EXPORT int     *intCalloc (int);
SUPERLU_EXPORT void    superlu_free (void*);
SUPERLU_EXPORT void    SetIWork (int, int, int, int *, int **, int **, int **,
                         int **, int **, int **, int **);
SUPERLU_EXPORT int     sp_coletree (int *, int *, int *, int, int, int *);
SUPERLU_EXPORT void    relax_snode (const int, int *, const int, int *, int *);
SUPERLU_EXPORT void    heap_relax_snode (const int, int *, const int, int *, int *);
SUPERLU_EXPORT int     mark_relax(int, int *, int *, int *, int *, int *, int *);
SUPERLU_EXPORT void    ilu_relax_snode (const int, int *, const int, int *,
				int *, int *);
SUPERLU_EXPORT void    ilu_heap_relax_snode (const int, int *, const int, int *,
				     int *, int*);
SUPERLU_EXPORT void    resetrep_col (const int, const int *, int *);
SUPERLU_EXPORT int     spcoletree (int *, int *, int *, int, int, int *);
SUPERLU_EXPORT int     *TreePostorder (int, int *);
SUPERLU_EXPORT double  SuperLU_timer_ ();
SUPERLU_EXPORT int     sp_ienv (int);
SUPERLU_EXPORT int     xerbla_ (char *, int *);
SUPERLU_EXPORT void    ifill (int *, int, int);
SUPERLU_EXPORT void    snode_profile (int, int *);
SUPERLU_EXPORT void    super_stats (int, int *);
SUPERLU_EXPORT void    check_repfnz(int, int, int, int *);
SUPERLU_EXPORT void    PrintSumm (char *, int, int, int);
SUPERLU_EXPORT void    StatInit(SuperLUStat_t *);
SUPERLU_EXPORT void    StatPrint (SuperLUStat_t *);
SUPERLU_EXPORT void    StatFree(SuperLUStat_t *);
SUPERLU_EXPORT void    print_panel_seg(int, int, int, int, int *, int *);
SUPERLU_EXPORT int     print_int_vec(char *,int, int *);
SUPERLU_EXPORT int     slu_PrintInt10(char *, int, int *);
