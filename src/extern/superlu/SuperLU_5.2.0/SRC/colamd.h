...
SUPERLU_EXPORT int colamd_recommended		/* returns recommended value of Alen, */
...
SUPERLU_EXPORT void colamd_set_defaults	/* sets default parameters */
(				/* knobs argument is modified on output */
    double knobs [COLAMD_KNOBS]	/* parameter settings for colamd */
) ;

SUPERLU_EXPORT int colamd			/* returns (1) if successful, (0) otherwise*/
...
SUPERLU_EXPORT int symamd				/* return (1) if OK, (0) otherwise */
(
...
SUPERLU_EXPORT void colamd_report
(
    int stats [COLAMD_STATS]
) ;

SUPERLU_EXPORT void symamd_report
(
    int stats [COLAMD_STATS]
) ;
