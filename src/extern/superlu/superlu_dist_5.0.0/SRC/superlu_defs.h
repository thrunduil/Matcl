...
SUPERLU_EXPORT  void   set_default_options_dist(superlu_dist_options_t *);
SUPERLU_EXPORT  void   superlu_gridinit(MPI_Comm, int_t, int_t, gridinfo_t *);
SUPERLU_EXPORT  void   superlu_gridmap(MPI_Comm, int_t, int_t, int_t [], int_t,
			      gridinfo_t *);
SUPERLU_EXPORT  void   superlu_gridexit(gridinfo_t *);
SUPERLU_EXPORT  void   print_options_dist(superlu_dist_options_t *);
SUPERLU_EXPORT  void   print_sp_ienv_dist(superlu_dist_options_t *);
SUPERLU_EXPORT  void   Destroy_CompCol_Matrix_dist(SuperMatrix *);
SUPERLU_EXPORT  void   Destroy_SuperNode_Matrix_dist(SuperMatrix *);
SUPERLU_EXPORT  void   Destroy_SuperMatrix_Store_dist(SuperMatrix *);
SUPERLU_EXPORT  void   Destroy_CompCol_Permuted_dist(SuperMatrix *);
SUPERLU_EXPORT  void   Destroy_CompRowLoc_Matrix_dist(SuperMatrix *);
SUPERLU_EXPORT  void   Destroy_CompRow_Matrix_dist(SuperMatrix *);
SUPERLU_EXPORT  void   sp_colorder (superlu_dist_options_t*, SuperMatrix*, int_t*, int_t*,
			   SuperMatrix*);
SUPERLU_EXPORT  int    sp_symetree_dist(int_t *, int_t *, int_t *, int_t, int_t *);
SUPERLU_EXPORT  int    sp_coletree_dist (int_t *, int_t *, int_t *, int_t, int_t, int_t *);
SUPERLU_EXPORT  void   get_perm_c_dist(int_t, int_t, SuperMatrix *, int_t *);
SUPERLU_EXPORT  void   at_plus_a_dist(const int_t, const int_t, int_t *, int_t *,
			     int_t *, int_t **, int_t **);
SUPERLU_EXPORT  int    genmmd_dist_(int_t *, int_t *, int_t *a, 
			   int_t *, int_t *, int_t *, int_t *, 
			   int_t *, int_t *, int_t *, int_t *, int_t *);
SUPERLU_EXPORT  void  bcast_tree(void *, int, MPI_Datatype, int, int,
			gridinfo_t *, int, int *);
SUPERLU_EXPORT  int_t symbfact(superlu_dist_options_t *, int, SuperMatrix *, int_t *,
                      int_t *, Glu_persist_t *, Glu_freeable_t *);
SUPERLU_EXPORT  int_t symbfact_SubInit(fact_t, void *, int_t, int_t, int_t, int_t,
			      Glu_persist_t *, Glu_freeable_t *);
SUPERLU_EXPORT  int_t symbfact_SubXpand(int_t, int_t, int_t, MemType, int_t *,
			       Glu_freeable_t *);
SUPERLU_EXPORT  int_t symbfact_SubFree(Glu_freeable_t *);
SUPERLU_EXPORT  void    countnz_dist (const int_t, int_t *, 
			     long long int *, long long int *,
			     Glu_persist_t *, Glu_freeable_t *);
SUPERLU_EXPORT  long long int fixupL_dist (const int_t, const int_t *, Glu_persist_t *,
				  Glu_freeable_t *);
SUPERLU_EXPORT  int_t   *TreePostorder_dist (int_t, int_t *);
SUPERLU_EXPORT  float   smach_dist(char *);
SUPERLU_EXPORT  double  dmach_dist(char *);
SUPERLU_EXPORT  void    *superlu_malloc_dist (size_t);
SUPERLU_EXPORT  void    superlu_free_dist (void*);
SUPERLU_EXPORT  int_t   *intMalloc_dist (int_t);
SUPERLU_EXPORT  int_t   *intCalloc_dist (int_t);
SUPERLU_EXPORT  int_t   mc64id_dist(int_t *);

/* Auxiliary routines */
SUPERLU_EXPORT  double SuperLU_timer_ ();
SUPERLU_EXPORT  void   superlu_abort_and_exit_dist(char *);
SUPERLU_EXPORT  int_t  sp_ienv_dist (int_t);
SUPERLU_EXPORT  void   ifill_dist (int_t *, int_t, int_t);
SUPERLU_EXPORT  void   super_stats_dist (int_t, int_t *);
SUPERLU_EXPORT  void   ScalePermstructInit(const int_t, const int_t, 
				   ScalePermstruct_t *);
SUPERLU_EXPORT  void   ScalePermstructFree(ScalePermstruct_t *);
SUPERLU_EXPORT  void  get_diag_procs(int_t, Glu_persist_t *, gridinfo_t *, int_t *,
			    int_t **, int_t **);
SUPERLU_EXPORT  int_t QuerySpace_dist(int_t, int_t, Glu_freeable_t *, superlu_dist_mem_usage_t *);
SUPERLU_EXPORT  int   xerr_dist (char *, int *);
SUPERLU_EXPORT  void  pxerr_dist (char *, gridinfo_t *, int_t);
SUPERLU_EXPORT  void  PStatInit(SuperLUStat_t *);
SUPERLU_EXPORT  void  PStatFree(SuperLUStat_t *);
SUPERLU_EXPORT  void  PStatPrint(superlu_dist_options_t *, SuperLUStat_t *, gridinfo_t *);
SUPERLU_EXPORT  void  log_memory(long long, SuperLUStat_t *);
SUPERLU_EXPORT  void  print_memorylog(SuperLUStat_t *, char *);

/* Prototypes for parallel symbolic factorization */
SUPERLU_EXPORT  float symbfact_dist
...
SUPERLU_EXPORT  float get_perm_c_parmetis 
...
SUPERLU_EXPORT  int_t psymbfact_LUXpandMem
(int_t, int_t, int_t, int_t, int_t, int_t, int_t, int_t, 
 Pslu_freeable_t *, Llu_symbfact_t *,  vtcsInfo_symbfact_t *, psymbfact_stat_t *);

SUPERLU_EXPORT  int_t psymbfact_LUXpand
(int_t, int_t, int_t, int_t, int_t *, int_t, int_t, int_t, int_t, 
 Pslu_freeable_t *, Llu_symbfact_t *,  vtcsInfo_symbfact_t *, psymbfact_stat_t *);

SUPERLU_EXPORT  int_t psymbfact_LUXpand_RL
(int_t, int_t, int_t, int_t, int_t, int_t,
 Pslu_freeable_t *, Llu_symbfact_t *, vtcsInfo_symbfact_t *, psymbfact_stat_t *);

SUPERLU_EXPORT  int_t psymbfact_prLUXpand
(int_t,  int_t, int, Llu_symbfact_t *, psymbfact_stat_t *);

#ifdef GPU_ACC   /* GPU related */
SUPERLU_EXPORT  void gemm_division_cpu_gpu (int *, int *, int *, int,
				   int, int, int *, int);
SUPERLU_EXPORT  int_t get_cublas_nb ();
SUPERLU_EXPORT  int_t get_num_cuda_streams ();
#endif

SUPERLU_EXPORT  int compare_pair (const void *, const void *);
SUPERLU_EXPORT  int get_thread_per_process();
SUPERLU_EXPORT  int_t get_max_buffer_size ();
SUPERLU_EXPORT  int_t get_min (int_t *, int_t);
SUPERLU_EXPORT  int_t static_partition (struct pair *, int_t, int_t *, int_t,
			       int_t *, int_t *, int);

/* Routines for debugging */
SUPERLU_EXPORT  void  print_panel_seg_dist(int_t, int_t, int_t, int_t, int_t *, int_t *);
SUPERLU_EXPORT  void  check_repfnz_dist(int_t, int_t, int_t, int_t *);
SUPERLU_EXPORT  int_t CheckZeroDiagonal(int_t, int_t *, int_t *, int_t *);
SUPERLU_EXPORT  void  PrintDouble5(char *, int_t, double *);
SUPERLU_EXPORT  void  PrintInt10(char *, int_t, int_t *);
SUPERLU_EXPORT  void  PrintInt32(char *, int, int *);
SUPERLU_EXPORT  int   file_PrintInt10(FILE *, char *, int_t, int_t *);
SUPERLU_EXPORT  int   file_PrintInt32(FILE *, char *, int, int *);
SUPERLU_EXPORT  int   file_PrintLong10(FILE *, char *, int_t, int_t *);
