...
SUPERLU_EXPORT  void    zallocateA_dist (int_t, int_t, doublecomplex **, int_t **, int_t **);
SUPERLU_EXPORT  void    zGenXtrue_dist (int_t, int_t, doublecomplex *, int_t);
SUPERLU_EXPORT  void    zFillRHS_dist (char *, int_t, doublecomplex *, int_t,
                              SuperMatrix *, doublecomplex *, int_t);
SUPERLU_EXPORT  int     zcreate_matrix(SuperMatrix *, int, doublecomplex **, int *, 
			      doublecomplex **, int *, FILE *, gridinfo_t *);
SUPERLU_EXPORT  int     zcreate_matrix_rb(SuperMatrix *, int, doublecomplex **, int *, 
			      doublecomplex **, int *, FILE *, gridinfo_t *);
SUPERLU_EXPORT  int     zcreate_matrix_dat(SuperMatrix *, int, doublecomplex **, int *, 
			      doublecomplex **, int *, FILE *, gridinfo_t *);

/* Driver related */
SUPERLU_EXPORT  void    zgsequ_dist (SuperMatrix *, double *, double *, double *,
			    double *, double *, int_t *);
SUPERLU_EXPORT  double  zlangs_dist (char *, SuperMatrix *);
SUPERLU_EXPORT  void    zlaqgs_dist (SuperMatrix *, double *, double *, double,
			    double, double, char *);
SUPERLU_EXPORT  void    pzgsequ (SuperMatrix *, double *, double *, double *,
			double *, double *, int_t *, gridinfo_t *);
SUPERLU_EXPORT  double  pzlangs (char *, SuperMatrix *, gridinfo_t *);
SUPERLU_EXPORT  void    pzlaqgs (SuperMatrix *, double *, double *, double,
			double, double, char *);
SUPERLU_EXPORT  int     pzPermute_Dense_Matrix(int_t, int_t, int_t [], int_t[],
				      doublecomplex [], int, doublecomplex [], int, int,
				      gridinfo_t *);

SUPERLU_EXPORT  int     sp_ztrsv_dist (char *, char *, char *, SuperMatrix *,
			      SuperMatrix *, doublecomplex *, int *);
SUPERLU_EXPORT  int     sp_zgemv_dist (char *, doublecomplex, SuperMatrix *, doublecomplex *,
			      int, doublecomplex, doublecomplex *, int);
SUPERLU_EXPORT  int     sp_zgemm_dist (char *, int, doublecomplex, SuperMatrix *,
                        doublecomplex *, int, doublecomplex, doublecomplex *, int);

SUPERLU_EXPORT  float zdistribute(fact_t, int_t, SuperMatrix *, Glu_freeable_t *, 
			 LUstruct_t *, gridinfo_t *);
SUPERLU_EXPORT  void  pzgssvx_ABglobal(superlu_dist_options_t *, SuperMatrix *, 
			      ScalePermstruct_t *, doublecomplex *,
			      int, int, gridinfo_t *, LUstruct_t *, double *,
			      SuperLUStat_t *, int *);
SUPERLU_EXPORT  float pzdistribute(fact_t, int_t, SuperMatrix *, 
			 ScalePermstruct_t *, Glu_freeable_t *, 
			 LUstruct_t *, gridinfo_t *);
SUPERLU_EXPORT  void  pzgssvx(superlu_dist_options_t *, SuperMatrix *, 
		     ScalePermstruct_t *, doublecomplex *,
		     int, int, gridinfo_t *, LUstruct_t *,
		     SOLVEstruct_t *, double *, SuperLUStat_t *, int *);
SUPERLU_EXPORT  int  zSolveInit(superlu_dist_options_t *, SuperMatrix *, int_t [], int_t [],
		       int_t, LUstruct_t *, gridinfo_t *, SOLVEstruct_t *);
SUPERLU_EXPORT  void zSolveFinalize(superlu_dist_options_t *, SOLVEstruct_t *);
SUPERLU_EXPORT  int  zldperm_dist(int_t, int_t, int_t, int_t [], int_t [],
...
SUPERLU_EXPORT  int_t pzgstrf(superlu_dist_options_t *, int, int, double,
		    LUstruct_t*, gridinfo_t*, SuperLUStat_t*, int*);
SUPERLU_EXPORT  void pzgstrs_Bglobal(int_t, LUstruct_t *, gridinfo_t *,
			     doublecomplex *, int_t, int, SuperLUStat_t *, int *);
SUPERLU_EXPORT  void pzgstrs(int_t, LUstruct_t *, ScalePermstruct_t *, gridinfo_t *,
		    doublecomplex *, int_t, int_t, int_t, int, SOLVEstruct_t *,
		    SuperLUStat_t *, int *);
SUPERLU_EXPORT  void zlsum_fmod(doublecomplex *, doublecomplex *, doublecomplex *, doublecomplex *,
		       int, int, int_t , int_t *, int_t, int_t, int_t,
		       int_t *, gridinfo_t *, LocalLU_t *, 
		       MPI_Request [], SuperLUStat_t *);
SUPERLU_EXPORT  void zlsum_bmod(doublecomplex *, doublecomplex *, doublecomplex *,
                       int, int_t, int_t *, int_t *, Ucb_indptr_t **,
                       int_t **, int_t *, gridinfo_t *, LocalLU_t *,
		       MPI_Request [], SuperLUStat_t *);
SUPERLU_EXPORT  void pzgsrfs(int_t, SuperMatrix *, double, LUstruct_t *,
		    ScalePermstruct_t *, gridinfo_t *,
		    doublecomplex [], int_t, doublecomplex [], int_t, int,
		    SOLVEstruct_t *, double *, SuperLUStat_t *, int *);
SUPERLU_EXPORT  void pzgsrfs_ABXglobal(int_t, SuperMatrix *, double, LUstruct_t *,
		  gridinfo_t *, doublecomplex *, int_t, doublecomplex *, int_t,
		  int, double *, SuperLUStat_t *, int *);
SUPERLU_EXPORT  int   pzgsmv_AXglobal_setup(SuperMatrix *, Glu_persist_t *,
				   gridinfo_t *, int_t *, int_t *[],
				   doublecomplex *[], int_t *[], int_t []);
SUPERLU_EXPORT  int  pzgsmv_AXglobal(int_t, int_t [], doublecomplex [], int_t [],
	                       doublecomplex [], doublecomplex []);
SUPERLU_EXPORT  int  pzgsmv_AXglobal_abs(int_t, int_t [], doublecomplex [], int_t [],
				 doublecomplex [], double []);
SUPERLU_EXPORT  void pzgsmv_init(SuperMatrix *, int_t *, gridinfo_t *,
			pzgsmv_comm_t *);
SUPERLU_EXPORT  void pzgsmv(int_t, SuperMatrix *, gridinfo_t *, pzgsmv_comm_t *,
		   doublecomplex x[], doublecomplex ax[]);
SUPERLU_EXPORT  void pzgsmv_finalize(pzgsmv_comm_t *);

/* Memory-related */
SUPERLU_EXPORT  doublecomplex  *doublecomplexMalloc_dist(int_t);
SUPERLU_EXPORT  doublecomplex  *doublecomplexCalloc_dist(int_t);
...
SUPERLU_EXPORT  int_t zQuerySpace_dist(int_t, LUstruct_t *, gridinfo_t *,
			      SuperLUStat_t *, superlu_dist_mem_usage_t *);

/* Auxiliary routines */
SUPERLU_EXPORT  void    zfill_dist (doublecomplex *, int_t, doublecomplex);
SUPERLU_EXPORT  void    zinf_norm_error_dist (int_t, int_t, doublecomplex*, int_t,
                                     doublecomplex*, int_t, gridinfo_t*);
SUPERLU_EXPORT  void    pzinf_norm_error(int, int_t, int_t, doublecomplex [], int_t,
				doublecomplex [], int_t , gridinfo_t *);
SUPERLU_EXPORT  void  zreadhb_dist (int, FILE *, int_t *, int_t *, int_t *, 
			   doublecomplex **, int_t **, int_t **);
SUPERLU_EXPORT  void  zreadtriple_dist(FILE *, int_t *, int_t *, int_t *,
			 doublecomplex **, int_t **, int_t **);
SUPERLU_EXPORT  void  zreadrb_dist(int, FILE *, int_t *, int_t *, int_t *,
		     doublecomplex **, int_t **, int_t **);
SUPERLU_EXPORT  void  zreadMM_dist(FILE *, int_t *, int_t *, int_t *,
	                  doublecomplex **, int_t **, int_t **);

/* Distribute the data for numerical factorization */
SUPERLU_EXPORT  float zdist_psymbtonum(fact_t, int_t, SuperMatrix *,
                                ScalePermstruct_t *, Pslu_freeable_t *, 
                                LUstruct_t *, gridinfo_t *);


/* Routines for debugging */
SUPERLU_EXPORT  void  zPrintLblocks(int, int_t, gridinfo_t *, Glu_persist_t *,
		 	   LocalLU_t *);
SUPERLU_EXPORT  void  zPrintUblocks(int, int_t, gridinfo_t *, Glu_persist_t *,
			   LocalLU_t *);
SUPERLU_EXPORT  void  zPrint_CompCol_Matrix_dist(SuperMatrix *);
SUPERLU_EXPORT  void  zPrint_Dense_Matrix_dist(SuperMatrix *);
SUPERLU_EXPORT  int   zPrint_CompRowLoc_Matrix_dist(SuperMatrix *);
SUPERLU_EXPORT  void  PrintDoublecomplex(char *, int_t, doublecomplex *);
SUPERLU_EXPORT  int   file_PrintDoublecomplex(FILE *fp, char *, int_t, doublecomplex *);


/* BLAS */

#ifdef USE_VENDOR_BLAS
SUPERLU_EXPORT  void zgemm_(const char*, const char*, const int*, const int*, const int*,
...
SUPERLU_EXPORT  void ztrsv_(char*, char*, char*, int*, doublecomplex*, int*,
                  doublecomplex*, int*, int, int, int);
SUPERLU_EXPORT  void ztrsm_(char*, char*, char*, char*, int*, int*, 
                  doublecomplex*, doublecomplex*, int*, doublecomplex*, 
                  int*, int, int, int, int);
SUPERLU_EXPORT  void zgemv_(char *, int *, int *, doublecomplex *, doublecomplex *a, int *, 
                  doublecomplex *, int *, doublecomplex *, doublecomplex *, int *, int);
SUPERLU_EXPORT  void zgeru_(int*, int*, doublecomplex*, doublecomplex*, int*,
                 doublecomplex*, int*, doublecomplex*, int*);

#else
SUPERLU_EXPORT  int zgemm_(const char*, const char*, const int*, const int*, const int*,
                   const doublecomplex*,  const doublecomplex*,  const int*,  const doublecomplex*,
                   const int*,  const doublecomplex*, doublecomplex*, const int*);
SUPERLU_EXPORT  int ztrsv_(char*, char*, char*, int*, doublecomplex*, int*,
                  doublecomplex*, int*);
SUPERLU_EXPORT  int ztrsm_(char*, char*, char*, char*, int*, int*, 
                  doublecomplex*, doublecomplex*, int*, doublecomplex*, int*);
SUPERLU_EXPORT  int zgemv_(char *, int *, int *, doublecomplex *, doublecomplex *a, int *, 
                  doublecomplex *, int *, doublecomplex *, doublecomplex *, int *);
SUPERLU_EXPORT  int zgeru_(int*, int*, doublecomplex*, doublecomplex*, int*,
                 doublecomplex*, int*, doublecomplex*, int*);
