...
typedef int64_t MPIUNI_INT64;
typedef uint64_t MPIUNI_UINT64;
#else
...
/*
  ...
  the 'MPI' functions to use 'superlu_MPI' namespace.
...
*/
#define MPI_Abort         superlu_MPI_Abort
#define MPI_Attr_get      superlu_MPI_Attr_get
#define MPI_Keyval_free   superlu_MPI_Keyval_free
#define MPI_Attr_put      superlu_MPI_Attr_put
#define MPI_Attr_delete   superlu_MPI_Attr_delete
#define MPI_Keyval_create superlu_MPI_Keyval_create
#define MPI_Comm_free     superlu_MPI_Comm_free
#define MPI_Comm_dup      superlu_MPI_Comm_dup
#define MPI_Comm_create   superlu_MPI_Comm_create
#define MPI_Init          superlu_MPI_Init
#define MPI_Finalize      superlu_MPI_Finalize
#define MPI_Initialized   superlu_MPI_Initialized
#define MPI_Finalized     superlu_MPI_Finalized
#define MPI_Comm_size     superlu_MPI_Comm_size
#define MPI_Comm_rank     superlu_MPI_Comm_rank
#define MPI_Wtime         superlu_MPI_Wtime

/* identical C bindings */
#define MPI_Comm_create_keyval superlu_MPI_Keyval_create
#define MPI_Comm_free_keyval   superlu_MPI_Keyval_free
#define MPI_Comm_get_attr      superlu_MPI_Attr_get
#define MPI_Comm_set_attr      superlu_MPI_Attr_put
