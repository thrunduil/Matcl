...
REM
set VC_PATH="C:\Program Files (x86)\Microsoft Visual Studio 14.0\VC\bin"
%VC_PATH%\vcvars32.bat && %VC_PATH%\lib.exe /def:..\..\..\lib\libptscotch.def /out:..\..\..\lib\libptscotch.lib
