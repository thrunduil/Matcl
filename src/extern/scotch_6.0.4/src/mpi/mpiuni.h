...
/*
  ...
  the 'MPI' functions to use 'Scotch_MPI' namespace.
...
*/
#define MPI_Abort         Scotch_MPI_Abort
#define MPI_Attr_get      Scotch_MPI_Attr_get
#define MPI_Keyval_free   Scotch_MPI_Keyval_free
#define MPI_Attr_put      Scotch_MPI_Attr_put
#define MPI_Attr_delete   Scotch_MPI_Attr_delete
#define MPI_Keyval_create Scotch_MPI_Keyval_create
#define MPI_Comm_free     Scotch_MPI_Comm_free
#define MPI_Comm_dup      Scotch_MPI_Comm_dup
#define MPI_Comm_create   Scotch_MPI_Comm_create
#define MPI_Init          Scotch_MPI_Init
#define MPI_Finalize      Scotch_MPI_Finalize
#define MPI_Initialized   Scotch_MPI_Initialized
#define MPI_Finalized     Scotch_MPI_Finalized
#define MPI_Comm_size     Scotch_MPI_Comm_size
#define MPI_Comm_rank     Scotch_MPI_Comm_rank
#define MPI_Wtime         Scotch_MPI_Wtime

/* identical C bindings */
#define MPI_Comm_create_keyval Scotch_MPI_Keyval_create
#define MPI_Comm_free_keyval   Scotch_MPI_Keyval_free
#define MPI_Comm_get_attr      Scotch_MPI_Attr_get
#define MPI_Comm_set_attr      Scotch_MPI_Attr_put
