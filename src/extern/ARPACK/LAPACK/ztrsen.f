      SUBROUTINE AR_ZTRSEN( JOB, COMPQ, SELECT, N, T, LDT, Q, LDQ, W, M, S,
     $                   SEP, WORK, LWORK, INFO )
*
...
*  =======
*
*  AR_ZTRSEN reorders the Schur factorization of a complex matrix
...
*  ===============
*
*  AR_ZTRSEN first collects the selected eigenvalues by computing a unitary
