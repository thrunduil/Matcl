      SUBROUTINE AR_CTRSEN( JOB, COMPQ, SELECT, N, T, LDT, Q, LDQ, W, M, S,
     $                   SEP, WORK, LWORK, INFO )
*
...
*  =======
*
*  AR_CTRSEN reorders the Schur factorization of a complex matrix
...
*  ===============
*
*  AR_CTRSEN first collects the selected eigenvalues by computing a unitary
