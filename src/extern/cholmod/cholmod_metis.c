...
)
{
    ...
    /// options changed in Metis 5
    int Opt [METIS_NOPTIONS], nn, csp ;
    size_t n1 ;
    DEBUG (Int nsep) ;
    ...
    //PK: ComputeVertexSeparator uses only vertex weights
    {
        /* METIS_NodeComputeSeparator (&nn, Mp, Mi, Mnw, Mew, Opt, &csp, Mpart) ;*/ /* Experiment by JS ACHTUNG */
