...
CHOLMOD_EXPORT cholmod_factor *cholmod_l_analyze (cholmod_sparse *, cholmod_common *) ;
...
CHOLMOD_EXPORT int cholmod_l_factorize (cholmod_sparse *, cholmod_factor *, cholmod_common *) ;
