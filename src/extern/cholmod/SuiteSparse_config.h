...
/* ========================================================================== */
/* === Config by Juliusz Stasiewicz follows ================================= */
#define NPRINT /* Do not print anything. */
#define DLONG  /* Use long as int and double as real */
#define NGPL   /* Do not use any GPLed code. */
/* === Any changes introduced in IBS are above this point =================== */
/* ========================================================================== */
...
#ifdef THIS_SHOULD_NEVER_EVER_BE_DEFINED_WE_ACCEPT_ONLY_INT32_FOR_NOW 
#ifdef _WIN64
...
#endif
#else // THIS SHOULD ALWAYS BE COMPILED - INT32

#define SuiteSparse_long int
#define SuiteSparse_long_max INT_MAX
