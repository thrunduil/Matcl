...
CHOLMOD_EXPORT int cholmod_l_print_sparse (cholmod_sparse *, const char *, cholmod_common *) ;
...
CHOLMOD_EXPORT int cholmod_l_print_factor (cholmod_factor *, const char *, cholmod_common *) ;
...
CHOLMOD_EXPORT int cholmod_l_print_triplet (cholmod_triplet *, const char *, cholmod_common *);
