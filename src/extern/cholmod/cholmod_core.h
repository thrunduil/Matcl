...
#ifndef __unix__
#define CHOLMOD_EXPORT __declspec(dllexport) //TODO:
#else
#undef CHOLMOD_EXPORT
...
#define CHOLMOD_DOUBLE 1	/* all numerical values are double */
#define CHOLMOD_SINGLE 0	/* all numerical values are float */
...
typedef CHOLMOD_EXPORT struct cholmod_common_struct
{
    /* ---------------------------------------------------------------------- */
...
CHOLMOD_EXPORT int cholmod_l_start (cholmod_common *) ;
...
CHOLMOD_EXPORT int cholmod_l_finish (cholmod_common *) ;
...
typedef CHOLMOD_EXPORT struct cholmod_sparse_struct
{
...
CHOLMOD_EXPORT cholmod_sparse *cholmod_l_allocate_sparse (size_t, size_t, size_t, int, int,
...
CHOLMOD_EXPORT int cholmod_l_free_sparse (cholmod_sparse **, cholmod_common *) ;
...
CHOLMOD_EXPORT cholmod_factor *cholmod_l_allocate_factor (size_t, cholmod_common *) ;
...
CHOLMOD_EXPORT int cholmod_l_free_factor (cholmod_factor **, cholmod_common *) ;
...
CHOLMOD_EXPORT cholmod_sparse *cholmod_l_factor_to_sparse (cholmod_factor *,
	cholmod_common *) ;
...
typedef CHOLMOD_EXPORT struct cholmod_triplet_struct
{
    size_t nrow ;	/* the matrix is nrow-by-ncol */
    size_t ncol ;
    size_t nzmax ;	/* maximum number of entries in the matrix */
...
CHOLMOD_EXPORT cholmod_triplet *cholmod_l_allocate_triplet (size_t, size_t, size_t, int, int,
    cholmod_common *) ;
...
CHOLMOD_EXPORT int cholmod_l_free_triplet (cholmod_triplet **, cholmod_common *) ;
...
CHOLMOD_EXPORT cholmod_triplet *cholmod_l_sparse_to_triplet (cholmod_sparse *,
    cholmod_common *) ;
...
CHOLMOD_EXPORT cholmod_sparse *cholmod_l_triplet_to_sparse (cholmod_triplet *, size_t,
    cholmod_common *) ;
