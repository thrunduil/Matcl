...
// to unsigned integer type of the same type, then shift is performed and result
// is casted to floating point type
template<class Val, int Bits, class Simd_tag>
simd<Val, Bits, Simd_tag>  
shift_right(const simd<Val, Bits, Simd_tag>& x, unsigned int count);

// arithmetic shift right all elements; floating point type is implicitely casted to 
// signed integer type of the same type, then arithmetic shift is performed and result
// is casted to floating point type
template<class Val, int Bits, class Simd_tag>
simd<Val, Bits, Simd_tag>  
...
//-----------------------------------------------------------------------
// return 2^k; k is a floating point type representing an integer; TODO
// no checks are performed
template<class Val, int Bits, class Simd_tag>
simd<Val, Bits, Simd_tag> 
pow2k(const simd<Val, Bits, Simd_tag>& k);

// return a vector of floats containing 2^k; k is a vector of 32-bit integers; TODO
// no checks are performed
template<int Bits, class Simd_tag>
simd<float, Bits, Simd_tag> 
pow2ki(const simd<int32_t, Bits, Simd_tag>& k);

// return a vector of doubles containing 2^k; k is a vector of 64-bit integers; TODO
// no checks are performed
template<int Bits, class Simd_tag>
